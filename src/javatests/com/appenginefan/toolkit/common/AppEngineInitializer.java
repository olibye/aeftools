...
/**
 * Utility class for setting up a test for App Engine
 */
public class AppEngineInitializer {

  private AppEngineInitializer() {
  }

  /**
   * Resets the static services used by App Engine for an
   * in-memory test
   */
  public static void setupMockAppEngine() {
    Environment env =
